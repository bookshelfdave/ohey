...
class OheyTest < Minitest::Test
  ...
  def test_eval_simple
    ...
    assert_equal ["Linux", "3.11.0-15-generic","GNU/Linux"], o.value.flatten

    o = O.parse("select systems.vbox from virtualization")
    assert_equal ["guest"], o.value.flatten

    o = O.parse("select total, free, mapped from memory")
    assert_equal ["372020kB", "46580kB", "10032kB"], o.value.flatten

    o = O.parse("select $key from kernel.modules")
    assert_equal ["vboxsf", "dm_crypt", "ppdev", "parport_pc", "psmouse", "mac_hid", "nfsd", "serio_raw", "nfs_acl", "vboxvideo", "auth_rpcgss", "nfs", "fscache", "lockd", "drm", "i2c_piix4", "sunrpc", "ext2", "vboxguest", "lp", "parport", "vesafb", "video", "e1000"], o.value.flatten
    assert_equal 24, o.value.flatten.length

    o = O.parse("select $object.size from kernel.modules")
   assert_equal ["43820", "23111", "17711", "32866", "104093", "13253", "296365", "13413", "12883", "12658", "59609", "187669", "63355", "95174", "306660", "22299", "278837", "73909", "244206", "17799", "42466", "13876", "19574", "152205"], o.value.flatten
   assert_equal 24, o.value.flatten.length


    o = O.parse("select $key, $object.size from kernel.modules")
    assert_equal [["vboxsf", "43820"], ["dm_crypt", "23111"], ["ppdev", "17711"], ["parport_pc", "32866"], ["psmouse", "104093"], ["mac_hid", "13253"], ["nfsd", "296365"], ["serio_raw", "13413"], ["nfs_acl", "12883"], ["vboxvideo", "12658"], ["auth_rpcgss", "59609"], ["nfs", "187669"], ["fscache", "63355"], ["lockd", "95174"], ["drm", "306660"], ["i2c_piix4", "22299"], ["sunrpc", "278837"], ["ext2", "73909"], ["vboxguest", "244206"], ["lp", "17799"], ["parport", "42466"], ["vesafb", "13876"], ["video", "19574"], ["e1000", "152205"]], o.value
  end
